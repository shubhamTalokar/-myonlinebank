...
@WebServlet("/BankTraServlet")
public class BankTraServlet extends HttpServlet 
{
	PrintWriter out;
	String email;
	int acno1,acno2;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		acno1 = Integer.parseInt(request.getParameter("tacno1"));
		acno2 = Integer.parseInt(request.getParameter("tacno2"));
		...
		out.print("<div class='bodytext' style='padding:12px;' align='justify'>");
			...
			try 
			{
				if (db.moneyTrans(acno1,acno2,email, amt)==true)
				{
					status = true;
					msg="Bank Transfer Performed Successfully !!";
				...
				{
					status = true;
					msg="Bank Transfer not sucessful  !!";
					out.print("<div id='menu'> <div align='right' class='smallwhitetext' style='padding:9px;'> "
						+ "<a href='userhome.html'>User-Home</a> | "
						+ "<a href='myaccount.html'>My-Account</a> | "
						+ "<a href='trans.html'>Transactions</a> | "
